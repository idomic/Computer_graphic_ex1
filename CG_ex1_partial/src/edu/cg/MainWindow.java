...
public class MainWindow extends JFrame {
	...
	public static void main(String[] args) {
		//ImageProc.retargetSize(new BufferedImage(arg0, arg1, arg2)"C:/Users/Dana/Desktop", 18, 21);
	...
	public MainWindow() {
		...
		// Retarget 
				...
				// Retarget 
				JPanel panelVerticalsize = new JPanel();
				panelVerticalsize.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
				panelOperations.add(panelVerticalsize);
				panelVerticalsize.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));

				JButton btnVerticalsize = new JButton("Vertical size");

				btnVerticalsize.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						int width = (Integer)txtRetargetWidth.getValue();
						int height = (Integer)txtRetargetHeight.getValue();
						BufferedImage bckupimg=MainWindow.this.img;
				...
				btnVerticalsize.setEnabled(false);
				panelVerticalsize.add(btnRetarget);
				operationButtons.add(btnVerticalsize);

		// Retarget 
		JPanel panelHorizontalsize = new JPanel();
		panelHorizontalsize.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		panelOperations.add(panelHorizontalsize);
		panelHorizontalsize.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));

		JButton btnHorizontalsize = new JButton("Horizontal size");

		btnHorizontalsize.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int width = (Integer)txtRetargetWidth.getValue();
				int height = (Integer)txtRetargetHeight.getValue();
				BufferedImage bckupimg=MainWindow.this.img;
		...
		btnHorizontalsize.setEnabled(false);
		panelHorizontalsize.add(btnHorizontalsize);
		operationButtons.add(btnHorizontalsize);
